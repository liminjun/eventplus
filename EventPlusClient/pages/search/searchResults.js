...
(function () {
    ...
    ui.Pages.define(searchPageURI, {
        ...
        _generateFilters: function () {
            ...
            this._filters.push({ results: null, text: "将要进行的活动", predicate: function (item) { return item.group === "将要进行的活动"; } });
            this._filters.push({ results: null, text: "已经结束的活动", predicate: function (item) { return item.group === "已经结束的活动"; } });
        },
        ...
        _handleQuery: function (element, args) {
            ...
            var converterFunction = WinJS.Binding.converter(this._markText.bind(this)); 
            WinJS.Namespace.define("searchResults", { markText: "Test Value"});
        ...
        _initializeLayout: function (listView, viewState) {
            ...
            if (viewState === appViewState.snapped) {
                ...
                document.querySelector(".titlearea .pagesubtitle").textContent = "搜索结果“" + this._lastSearch + '”';
            }
        },
        ...
        _itemInvoked: function (args) {
            args.detail.itemPromise.done(function itemInvoked(item) {
                //根据对象内容去数据源里面查找
                //使用方法 getItemReference()
                var currentEventId = item.data.eventid;
                nav.navigate("/pages/itemDetail/itemDetail.html", { item: Data.getItemReference(item.data), eventid: currentEventId });
            });
        },
        ...
        _searchData: function (queryText) {
            ...
            if (window.Data) {
                originalResults = Data.items.createFiltered(function (item) {
                    return (item.title.indexOf(queryText) >= 0 || item.eventlocation.indexOf(queryText) >= 0 || item.eventcontent.indexOf(queryText) >= 0);
                });
            } else {
